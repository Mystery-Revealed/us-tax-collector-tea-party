...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-tax-collector-tea-party', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-tax-collector-tea-party] listening on :${config.port} — sessions live in memory only`);
});
